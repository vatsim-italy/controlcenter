...
return [
   ...
   */
    'S1' => [
        'GENERAL' => [
            'correctConnectNetwork' => 'Setup, Configure and Connect to the network',
            'understandsRole'       => 'Demonstrates understanding of the ATS role',
            'demonstratesService'  => 'Demonstrates understanding in providing service',
            'situationalAwareness'  => 'Demonstrates situational awareness',
            'commPriority' => 'Manages communication priority',
            'phraseology' => 'Uses correct phraseology',
            'tagsFpln' => 'Manages Tags and Flight Plans',
            'profBehaviour' => 'Displays professional behaviour and pleasant attitude',
        ],
        'ATC_COORDINATION' => [
            'coordinatesATC' => 'Coordinates with other ATC when required',
            'transferTag' => 'Correctly transferres aircraft to next controller',
        ],'CLEARANCE_DELIVERY' => [
            'correctFlightRules' => 'Correctly identifies aircraft and applies the correct flight rules',
            'basicAltimetry' => 'Applies basic altimetry',
            'clearanceInstructions' => 'Issues appropriate clearance and departure instructions',
            'handlingIncorrectFpl' => 'Displays correct behaviour in handling incorrect FPLs',
            'atisConfirmation' => 'Ensures pilot has received the correct ATIS information',
        ],
        'GROUND_OPERATIONS' => [
            'pushbackInstructions' => 'Issues appropriate pushback instructions',
            'taxiInstructions' => 'Issues appropriate taxi instructions',
        ],
        'LOCAL_COMPETENCIES' => [
            'knowledgeLoaSop' => 'Knowledge of and adherence to LoAs / SOPs',
        ],
        'EMOTIONAL_CONTROL' => [
            'selfBelief' => 'Show Self - Belief and remains Confident',
            'recoverMistakes' => 'Can recover from mistakes',
            'calmUnderPressure' => 'Stays calm under pressure',
        ],
    ],
